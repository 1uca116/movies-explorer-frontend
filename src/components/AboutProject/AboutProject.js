...
function AboutProject() {
    return(
        <section className='about-project' id="about">
            <h2 className="about-project__header section__heading">О проекте</h2>
            ...
            <div className="about-project__steps">
                ...
                <p className="about-project__steps-text about-project__steps-text_type_four-weeks">4 недели</p>
